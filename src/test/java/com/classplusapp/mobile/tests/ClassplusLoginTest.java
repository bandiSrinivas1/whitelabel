...
import com.classplusapp.mobile.pages.ClassplusLoginPage;
import com.classplusapp.mobile.tests.ClassplusBaseMobileAutomationTest;
...
@Epic("Login")
@Feature("Tutor Login")
public class ClassplusLoginTest extends ClassplusBaseMobileAutomationTest {
	private static final Logger logger = LogManager.getLogger(ClassplusLoginTest.class);
	ClassplusLoginPage tutorLoginPage = null;

	@BeforeClass
	@Parameters({ "deviceName_one", "udid_one", "platformName_one", "platformVersion_one", "url","clientApiKey"})
	public void initClass(String deviceName_one, String udid_one, String platformName_one, String platformVersion_one,String url,String clientApiKey) throws Exception {
		...
		this.tutorLoginPage = new ClassplusLoginPage(this.getMobileDriver(udid_one));
